...
if __name__ == '__main__':
    asyncio.run(StarTinG())    major_login.network_operator_a = "Verizon"
    major_login.network_type_a = "WIFI"
    major_login.client_using_version = "7428b253defc164018c604a1ebbfebdf"
    major_login.external_storage_total = 36235
    major_login.external_storage_available = 31335
                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG in ("/"):
                            ...
                            chat_id = response.Data.Chat_ID
                            msg1 = f"""
[b][c]{get_random_color()} xAlInAs BOT 
...
[b][c]{get_random_color()} Thanks for using xAlInAs Ghost BOT
...
[b][c]{get_random_color()} مو شكرا على استخدام بوتي
"""
                            P = await SEndMsG(response.Data.chat_type , msg , uid , chat_id , key , iv)
                            await SEndPacKeT(whisper_writer , online_writer , 'ChaT' , P)
